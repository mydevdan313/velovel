...
<?php
  if (!empty($data['propertyOrder']['usedsing'])) {
    if (is_file(SITE_DIR.'uploads'.DS.$data['propertyOrder']['sing'])) {
      $imgSing = '<img src="'.SITE.'/uploads/'.$data['propertyOrder']['sing'].'">';
    } elseif(is_file(SITE_DIR.'uploads'.DS.'sing.jpg')) {
      $imgSing = '<img src="'.SITE.'/uploads/sing.jpg">';
    }
    if (is_file(SITE_DIR.'uploads'.DS.$data['propertyOrder']['stamp'])) {
      $imgStamp = '<img src="'.SITE.'/uploads/'.$data['propertyOrder']['stamp'].'">';
    } elseif(is_file(SITE_DIR.'uploads'.DS.'stamp.jpg')) {
