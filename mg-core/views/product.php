...
<div class="c-product product-details-block">
    ...
    <div class="l-row">
                                            ...
                                            <div class="c-product__block--left">
                                                <div class="c-product__row">
                                                    <div class="c-product__code product-code">
                                                        ...
                                                        <span class="price">
                                                            <span itemprop="price" content="<?php echo str_replace(' ', '', $data['price'])?>"></span>
                                                            <span itemprop="priceCurrency" content="<?php echo $data['currency']; ?>"></span>
                                                        </span>
                                                    </div>
        ...
        <div class="l-col min-0--12">
            <?php if(class_exists('RecentlyViewed')): ?>[recently-viewed count=5 random=1]<?php endif; ?>
        </div>
        <div class="l-col min-0--12">
