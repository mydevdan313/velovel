                ...
                <div class="c-tab__content" id="c-tab__data">
                    <form class="c-form c-form--width" action="<?php echo SITE ?>/personal" method="POST">
                        ...
                        <div class="c-form__row" <?php echo $style ?>>
                            <input type="text" name="address_index" value="<?php echo $userInfo->address_index ?>" placeholder="<?php echo lang('orderPhAddressIndex'); ?>">
                        </div>
                        <div class="c-form__row" <?php echo $style ?>>
                            <input type="text" name="address_country" value="<?php echo $userInfo->address_country ?>" placeholder="<?php echo lang('orderPhAddressCountry'); ?>">
                        </div>
                        <div class="c-form__row" <?php echo $style ?>>
                            <input type="text" name="address_region" value="<?php echo $userInfo->address_region ?>" placeholder="<?php echo lang('orderPhAddressRegion'); ?>">
                        </div>
                        <div class="c-form__row" <?php echo $style ?>>
                            <input type="text" name="address_city" value="<?php echo $userInfo->address_city ?>" placeholder="<?php echo lang('orderPhAddressCity'); ?>">
                        </div>
                        <div class="c-form__row" <?php echo $style ?>>
                            <input type="text" name="address_street" value="<?php echo $userInfo->address_street ?>" placeholder="<?php echo lang('orderPhAddressStreet'); ?>">
                        </div>
                        <div class="c-form__row" <?php echo $style ?>>
                            <input type="text" name="address_house" value="<?php echo $userInfo->address_house ?>" placeholder="<?php echo lang('orderPhAddressHouse'); ?>">
                        </div>
                        <div class="c-form__row" <?php echo $style ?>>
                            <input type="text" name="address_flat" value="<?php echo $userInfo->address_flat ?>" placeholder="<?php echo lang('orderPhAddressFlat'); ?>">
                        </div>
