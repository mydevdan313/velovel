...
<div class="form-wrapper">
  ...
  <table class="form-table" cellpadding="5">
    <tr>
      <th bgcolor="#FFFFE0" width="30">№</th>
      <th bgcolor="#FFFFE0" width="100">Фото</th>
      <th bgcolor="#FFFFE0" >Артикул</th>
      <th bgcolor="#FFFFE0" width="290">Товар</th>
    ...
    foreach ($data['perOrders'] as $perOrder) {
      ...
      <tr>
        ...
        <td style="padding: 5px;"><img src="<?php echo $perOrder['image'] ?>"></td>
