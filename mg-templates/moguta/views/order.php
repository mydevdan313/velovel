                        ...
                        <div class="l-col min-0--12 min-990--6">
                            ...
                            <ul class="c-order__list form-list">
                                ...
                                <li class="c-order__list--item">
                                  <input type="text" class="address-area" placeholder="<?php echo lang('orderPhAdres'); ?>" name="address" value="<?php echo $_POST['address'] ?>">
                                </li>

                                <li class="addressPartsTitle"><?php echo lang('orderPhAdres'); ?>:</li>
                                <li class="c-order__list--item addressPartsTitle"> </li>
                                <li class="c-order__list--item addressPartsContainer">
                                  <input type="text" placeholder="<?php echo lang('orderPhAddressIndex'); ?>" name="address_index" value="<?php echo $_POST['address_index'] ?>">
                                </li>
                                <li class="c-order__list--item addressPartsContainer">
                                  <input type="text" placeholder="<?php echo lang('orderPhAddressCountry'); ?>" name="address_country" value="<?php echo $_POST['address_country'] ?>">
                                </li>
                                <li class="c-order__list--item addressPartsContainer">
                                  <input type="text" placeholder="<?php echo lang('orderPhAddressRegion'); ?>" name="address_region" value="<?php echo $_POST['address_region'] ?>">
                                </li>
                                <li class="c-order__list--item addressPartsContainer">
                                  <input type="text" placeholder="<?php echo lang('orderPhAddressCity'); ?>" name="address_city" value="<?php echo $_POST['address_city'] ?>">
                                </li>
                                <li class="c-order__list--item addressPartsContainer">
                                  <input type="text" placeholder="<?php echo lang('orderPhAddressStreet'); ?>" name="address_street" value="<?php echo $_POST['address_street'] ?>">
                                </li>
                                <li class="c-order__list--item addressPartsContainer">
                                  <input type="text" placeholder="<?php echo lang('orderPhAddressHouse'); ?>" name="address_house" value="<?php echo $_POST['address_house'] ?>">
                                </li>
                                <li class="c-order__list--item addressPartsContainer">
                                  <input type="text" placeholder="<?php echo lang('orderPhAddressFlat'); ?>" name="address_flat" value="<?php echo $_POST['address_flat'] ?>">
                                </li>                                
                                ...
                                <ul class="c-order__payment delivery-details-list">
                                    <?php foreach ($data['delivery'] as $delivery): ?>
                                        <li <?php echo ($delivery['checked']) ? 'class = "active"' : 'class = "noneactive"' ?>>
                                            <label data-delivery-date="<?php echo $delivery['date']; ?>" data-delivery-intervals='<?php echo $delivery["interval"]; ?>' data-delivery-address='<?php echo $delivery["address_parts"]; ?>'>
                                                <input type="radio"
